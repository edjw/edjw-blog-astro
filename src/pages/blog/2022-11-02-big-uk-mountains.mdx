...
tags:
 ...
 - geography
---
There's a very high mountain in the Cairngorms in Scotland called ["Sgor an Lochain Uaine"](https://www.google.com/maps/d/viewer?mid=1iOCGBdsMcbORzRdTSw7klktqU_5OlKI&ll=57.05826366073055%2C-3.725758513285524&z=18). It's 1,258m above sea level. That makes it the [5th highest mountain in the UK](https://en.wikipedia.org/wiki/Sg%C3%B2r_an_Lochain_Uaine). But as the whole of the Cairngorms are pretty high, it's not much higher than the surrounding area.
...
So how can you get a list of mountains that are likely to have a good view from the top. The [UK Prominent Peak Database](https://prominentpeaks.org.uk/index.php) is a list of the 1,530 mountains[^3] in the UK that are a) at least 500m above sea level, and b) have a prominence of at least 100m. They think this criteria makes it easier to find the UK mountains that probably have a good view at the top.
...
All GB: [CSV](/public/files/big-uk-mountains/All_GB_Peaks_P100+_H500+.csv) / [XLSX](/public/files/big-uk-mountains/All_GB_Peaks_P100+_H500+.xlsx)
P1000 (prominence of 1000m+): [CSV](/public/files/big-uk-mountains/P1000_GB_Peaks.csv) / [XLSX](/public/files/big-uk-mountains/P1000_GB_Peaks.xlsx)
P500: [CSV](/public/files/big-uk-mountains/P500_GB_Peaks.csv) / [XLSX](/public/files/big-uk-mountains/P500_GB_Peaks.xlsx)
P200: [CSV](/public/files/big-uk-mountains/P200_GB_Peaks.csv) / [XLSX](/public/files/big-uk-mountains/P200_GB_Peaks.xlsx)
P100: [CSV](/public/files/big-uk-mountains/P100_GB_Peaks.csv) / [XLSX](/public/files/big-uk-mountains/P100_GB_Peaks.xlsx)

I removed mountains in Northern Ireland. (Unfortunately I couldn't get my program to convert the OS map references for Northern Irish peaks into latitude/longitude which is needed for making the map above.) I also removed a few columns that weren't working any more.

There is another dataset called ["Database of British and Irish hills"](http://www.hills-database.co.uk/downloads.html) that seems to be updated regularly. It is extremely thorough (21,291 hills!) with data about peaks as low as just 2m above sea level!


[^1]: Although [this photo from the top of Sgor an Lochain Uaine](https://www.geograph.org.uk/photo/3067669) looks pretty good to me!
